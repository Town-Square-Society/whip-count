...
export const TRACKED_ISSUES = [{
    ...
    link: "#filibuster",
    description: "Do your Senators support reforming the 60-vote legislative filibuster? See the latest whip count.",
    ...
    link: "#dc-statehood",
    description: "Do your Senators support statehood for Washington, D.C.? See the latest whip count.",
    ...
    link: "#hr1",
    description: "Do your Senators support expanding Americans voting access and limiting the influence of money in our elections? See the latest whip count.",
    aboutLinkText: "See legislative details.",
    ...
    link: "#hr4",
    description: "Do your Senators support restoring and expanding the Voting Rights Act? See the latest whip count.",
    aboutLinkText: "See legislative details.",
