...
export const TRACKED_ISSUES = [{
    ...
    link: "#filibuster",
    description: "Do your Senators support reforming the 60-vote legislative filibuster? SEE LATEST WHIP COUNT.",
    ...
    link: "#dc-statehood",
    description: "Do your Senators support statehood for Washington, D.C.? SEE LATEST WHIP COUNT.",
    ...
    link: "#hr1",
    description: "Do your Senators support expanding Americans voting access and limiting the influence of money in our elections? SEE LATEST WHIP COUNT.",
    aboutLinkText: "See legislative details.",
    ...
    link: "#hr4",
    description: "Do your Senators support restoring and expanding the Voting Rights Act? SEE LATEST WHIP COUNT.",
    aboutLinkText: "See legislative details.",
